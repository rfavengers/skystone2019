...
@Autonomous(name = "A2ProgramBlue2FINALDontdelete (Blocks to Java)", group = "")
public class A2ProgramBlue2FINALDontdelete extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      moveForward(55 + 1);
      slideRight(122 + 0);
      turnForFoundation(0.7 + 0);
      slideLeft(190 + 0);
      turnForFoundation(0.4 + 0);
      moveBackward(180 + 1);
    }
  }
